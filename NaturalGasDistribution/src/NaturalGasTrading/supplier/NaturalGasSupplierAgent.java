...
public class NaturalGasSupplierAgent extends Agent {
...
private NaturalGasSupplierGui myGui;

/** The following parts, where the SLCodec and NaturalGasTradingOntology are
* registered
**/
...
myGui = new NaturalGasSupplierGuiImpl();
myGui.setAgent(this);
myGui.show();
...
sd.setName(getLocalName()+"-NaturalGas-tender");
dfd.addServices(sd);
try {
...
// Deadline expired
myGui.notifyUser("Cannot sell NaturalGas "+title);
...
CallForOfferServer() {
super(NaturalGasSupplierAgent.this, MessageTemplate.and(MessageTemplate.MatchOntology(ontology.getName()),MessageTemplate.MatchPerformative(ACLMessage.CFP)));
}
