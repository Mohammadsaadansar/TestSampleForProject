...
*/
public class NaturalGasSupplierGuiImpl extends JFrame implements NaturalGasSupplierGui {
private NaturalGasSupplierAgent myAgent;
...
public void setAgent(NaturalGasSupplierAgent a) {
myAgent = a;
setTitle(myAgent.getName());
}

public NaturalGasSupplierGuiImpl() {
super();
...
if (tc.showEditTimeDlg(NaturalGasSupplierGuiImpl.this) == TimeChooser.OK) {
deadline = tc.getDate();
...
//JOptionPane.showMessageDialog(NaturalGasSupplierGuiImpl.this, "Min price must be cheaper than best price", "WARNING", JOptionPane.WARNING_MESSAGE);
//}
}
catch (Exception ex1) {
// Invalid max cost
JOptionPane.showMessageDialog(NaturalGasSupplierGuiImpl.this, "Invalid min price", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
catch (Exception ex2) {
// Invalid desired cost
JOptionPane.showMessageDialog(NaturalGasSupplierGuiImpl.this, "Invalid best price", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
else {
// No deadline specified
JOptionPane.showMessageDialog(NaturalGasSupplierGuiImpl.this, "Invalid deadline", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
else {
// No company title specified
JOptionPane.showMessageDialog(NaturalGasSupplierGuiImpl.this, "No Company title specified", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
} );
