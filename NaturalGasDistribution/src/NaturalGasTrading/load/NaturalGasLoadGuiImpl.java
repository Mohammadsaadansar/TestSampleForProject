...
tries to buy NaturalGas on behalf of its user
*/
public class NaturalGasLoadGuiImpl extends JFrame implements NaturalGasLoadGui {
private NaturalGasLoadAgent myAgent;
...
if (tc.showEditTimeDlg(NaturalGasLoadGuiImpl.this) == TimeChooser.OK) {
deadline = tc.getDate();
...
// Invalid max cost
JOptionPane.showMessageDialog(NaturalGasLoadGuiImpl.this, "Invalid min cost", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
catch (Exception ex2) {
// Invalid desired cost
JOptionPane.showMessageDialog(NaturalGasLoadGuiImpl.this, "Invalid best cost", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
else {
// No deadline specified
JOptionPane.showMessageDialog(NaturalGasLoadGuiImpl.this, "Invalid deadline", "WARNING", JOptionPane.WARNING_MESSAGE);
}
}
else {
}
...
public void setAgent(NaturalGasLoadAgent a) {
myAgent = a;
